...
class AnalysisController extends Controller
{
    public function index()
    {
        ...
        ->groupBy('customer_id')  //customer_name 抜き
        ...
        // 4. 会員毎のRFMランクを計算 
        $rfmPrms = [
            14, 28, 60, 90, 7, 5, 3, 2, 300000, 200000, 100000, 30000 ];   //(仮配列)
        ...
        $mCount = DB::table($subQuery) 
            ...
            // dd($total, $eachCount, $fCount, $mCount);
